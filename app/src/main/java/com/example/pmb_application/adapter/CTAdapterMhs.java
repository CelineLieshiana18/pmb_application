...
public class CTAdapterMhs extends RecyclerView.Adapter<CTAdapterMhs.CTViewHolder> {
    ...
    public CTAdapterMhs(ItemClickListener clickListener) {
    ...
    public CTViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ct_item_mhs, parent,false);
